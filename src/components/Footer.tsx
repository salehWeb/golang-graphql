...
const Footer = () => {
  return (
    <footer className="p-8 flex flex-col gap-8">
      ...
      <div className="flex justify-center items-center">
        <div className="grid grid-cols-3 justify-start items-start gap-12 text-gray-200">
          <div className="flex flex-col gap-8 justify-between items-center h-full text-center">
            <h4 className="text-2xl">Address</h4>
            <p>Espresso Haven 123 Coffee Lane town, BT 45678</p>
          </div>
